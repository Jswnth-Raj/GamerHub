...
<div id="navbar" class="navbar-fixed scrollspy">
  ...
  <div id="index-banner" class="parallax-container valign-wrapper">
    ...
    <div class="parallax hide-on-large-only"><img src="images/wall5.jpg" alt="Unsplashed background img 2" ></div>
    <div class="parallax hide-on-med-and-down"><img src="images/wall5.jpg" alt="Unsplashed background img 2" height="00px"></div>
  </div>
      ...
      <div class="card grey darken-4">
        <div class="card-content white-text center">
          ...
          <?php
           if(isset($_GET['rset']))
           {
            echo "<br><span class='green-text'>Password Changed Successfully</span>";
           }
          ?>
          <?php
           if(isset($_GET['crt']))
           {
            echo "<br><span class='green-text'>Account Created Successfully</span>";
           }
          ?>

          <form action="login2.php" method="post">
            <div class="input-field col s12 ">
          <i class="fa fa-user prefix white-text" aria-hidden="true"></i>
          <input id="username" name="username" type="text" class="validate white-text" required autocomplete="off">
          <label for="username" class="white-text">Username</label>
            </div>
            <br>
            <div class="input-field col s12 ">
            <i class="fa fa-key prefix white-text" aria-hidden="true"></i>
          <input id="password" name="password" type="password" class="validate white-text" required autocomplete="off">
          <label for="password" class="white-text">Password</label>
            </div>
            <br><br><br>
            <button class="btn waves-effect waves-light deep-orange accent-3" type="submit" name="submit">Login
            <i class="fa fa-sign-in" aria-hidden="true"></i>
          </button>
        </form>
        <a href='forgot_username.php'class='grey-text'style="font-size:16px;">Forgot Username?</a><br><a href='forgot_password.php' class='grey-text'style="font-size:16px;">Forgot Password?</a> <br>
        <span>New User?</span><a href="signup.php"> Sign Up</a>
            <?php
      if(isset($_GET['fail']))
      {
        echo "<span style='color:red;font-size:13px;'><b>Username or Password Incorrect</b></span>";
      }
    ?>
      </div>
  </div>
