...
<head>
  ...
  <title>Gamer Hub Add Security Questions</title>
...
<div id="navbar" class="navbar-fixed scrollspy">
  ...
  <div id="index-banner" class="parallax-container valign-wrapper">
    ...
    <div class="parallax hide-on-large-only"><img src="images/wall3.jpg" alt="Unsplashed background img 2" ></div>
    <div class="parallax hide-on-med-and-down"><img src="images/wall3.jpg" alt="Unsplashed background img 2" height="00px"></div>
  </div>
...
<br><br>
    ...
    <div class="col s12">
      <div class="card white">
        <div class="card-content  center">
          <span class="card-title black-text">Sign Up</span><br>
          <span class="blue-text">Almost done one step ahead </span>
          <?php 
    if(isset($_SESSION['username']))
    {
      ...
      <div class="input-field col s12 ">
        <br>
       <select name="sec_que_1">
        <option value='Who is your Favourite Teacher' checked>Who is your Favourite Teacher</option>
        <option value="What is your Mother's Maidan Name">What is your Mother's Maidan Name</option>
        <option value="What is your Birth Place">What is your Birth Place</option>
        <option value="Who is your Favourite Cricketer">Who is your Favourite Cricketer</option>
        <option value="What is your Favourite Movie">What is your Favourite Movie</option>
       </select>
       <label for='sec_que_1' class="black-text">Security Question 1</label>
      </div>
       <div class="input-field col s12">
          <input id="sec_ans_1" name="sec_ans_1" type="text" class="validate black-text">
          <label for="sec_ans_1" class="black-text">Answer 1</label>
        </div>
        <div class="input-field col s12 ">
        <br>
       <select name="sec_que_2">
        <option value="What is your Mother Maidan Name " checked>What is your Mother's Maidan Name</option>
        <option value='Who is your Favourite Teacher'>Who is your Favourite Teacher</option>
        <option value="What is your Birth Place">What is your Birth Place</option>
        <option value="Who is your Favourite Cricketer">Who is your Favourite Cricketer</option>
        <option value="What is your Favourite Movie">What is your Favourite Movie</option>
      </select>
       <label for='sec_que_2' class="black-text">Security Question 2</label>
    </div>
       <div class="input-field col s12">
          <input id="sec_ans_2" name="sec_ans_2" type="text" class="validate black-text">
          <label for="sec_ans_2" class="black-text">Answer 2</label>
        </div>
        <div class='col s12'>
      <input type="hidden" name="uname1" id="uname1" value="<?php echo $uname?>">
      <button class="btn waves-effect waves-light deep-orange accent-3" type="submit" name="submit">Finish
