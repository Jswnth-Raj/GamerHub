...
<div id="navbar" class="navbar-fixed scrollspy">
  <nav class="  red darken-3 nav-extended">
    <div class="nav-wrapper container">
    	<div class="container"> <a href="#" class="brand-logo subTitleFont">My Notifications</a></div>
          ...
          while($row=mysqli_fetch_array($result))
            {
              ...
              echo "<td><b>".$row['notification']."<br><b></td>";
              echo "</tr>";
           ...
           {
            echo "<div class='container center'><b style='font-size:17px'>Sorry No Notifications  Yet...!</b></div>";
           }
        }
        else
        {
