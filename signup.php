    ...
    <div class="col s12">
      <div class="card grey darken-4">
        <div class="card-content white-text center">
          ...
          <div class="input-field col s12">
          <input id="mbl" name="mbl" type="number" class="validate white-text" required>
          <label for="mbl" class="white-text">Mobile Number</label>
          </div>
          <div class="input-field col s12">
          ...
          <div class="input-field col s12">
          <input id="cpassword" name="cpassword" type="password" class="validate white-text" required>
          <label for="password" class="white-text">Confirm Password</label>
          </div>
          <br><br><br><br>
            <button class="btn waves-effect waves-light deep-orange accent-3" type="submit" name="submit" onclick="return validate();">Create Account
