    ...
    <div class="col s12">
      <div class="card grey darken-4">
        <div class="card-content  center">
          ...
          <input id="uname" name="uname" type="text" class="validate white-text" required autocomplete="off">
          <label for="uname" class="white-text">Enter Username</label>
        </div>
        <div class="input-field col s12">
          <input id="my_email" name="my_email" type="email" class="validate white-text" required autocomplete="off">
          <label for="my_email" class="white-text">Enter Registered Email</label>
        </div>
          <button class="btn waves-effect waves-light deep-orange accent-3" type="submit" name="submit">Search
