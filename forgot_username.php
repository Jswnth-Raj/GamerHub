...
<head>
  ...
  <title>Gamer Hub Find Username</title>
...
<div id="navbar" class="navbar-fixed scrollspy">
  ...
  <div id="index-banner" class="parallax-container valign-wrapper">
    <div class="section no-pad-bot">
      <div class="container valign">
        ...
        <div class="row center">
            <h5 class="header col s12  black-text subTitleFont"><br><br><br><br><br><br><b>Don't just play the game; Earn from it.</b> </h5>
        </div>
        <div class="row center">
    ...
    <div class="parallax hide-on-large-only"><img src="images/wall7.jpg" alt="Unsplashed background img 2" ></div>
    <div class="parallax hide-on-med-and-down"><img src="images/wall7.jpg" alt="Unsplashed background img 2" height="00px"></div>
  </div>
    ...
    <div class="col s12">
      <div class="card grey darken-4">
        <div class="card-content  center">
          <span class="card-title white-text">Forgot Username</span><br>
          <form action="" method="post">
            <div class="input-field col s12">
          <input id="find_mob" name="find_mob" type="number" class="validate white-text" required>
          <label for="find_mob" class="white-text">Enter Registered Mobile Number</label>
          <button class="btn waves-effect waves-light deep-orange accent-3" type="submit" name="submit">Find Username
          ...
          <?php
              ...
              {
                $find_mob=$_POST['find_mob'];
                $sql="SELECT username FROM login WHERE mobile_number='$find_mob' LIMIT 1";
                if($result=mysqli_query($conn,$sql))
                    { 
                if(mysqli_num_rows($result)==1)
                      {
                        $row=mysqli_fetch_array($result);
                        echo "<span class='white-text'>Username: ".$row['username']."</span>";
                      }
                      else
                      {
                        echo "<span class='white-text'>Username not found....!</span>";
                      }
                    }
                    else
                    {
