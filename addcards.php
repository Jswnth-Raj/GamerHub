...
<div id="navbar" class="navbar-fixed scrollspy">
  <nav class="  green darken-4 nav-extended">
    <div class="nav-wrapper container">
    	<div class="container"> <a href="#" class="brand-logo subTitleFont">Add Money</a></div>
  ...
  <?php
      if(isset($_GET['low']))
      {
        echo "<h6 class='center'><span style='color:red'><b>Insufficient Money add more to continue our services....</b><h6></span>";
      }
    ?>
  </div>
  <br>
  ...
  <form action="addmoney.php" method="post">
      <input type="hidden" name="paybal" id="paybal" value="1">
      <button class="btn waves-effect waves-light  green darken-4" type="submit" name="submit" id="submit" style='width:230px'>₹10 rs
      <i class="material-icons right">send</i>
      </button>
    </form><br>
    <form action="addmoney.php" method="post">
      <input type="hidden" name="paybal" id="paybal" value="20">
      <button class="btn waves-effect waves-light  green darken-4" type="submit" name="submit" id="submit" style='width:230px'>₹20 rs
      <i class="material-icons right">send</i>
      </button>
    </form><br>
    <form action="addmoney.php" method="post">
      <input type="hidden" name="paybal" id="paybal" value="30">
     <button class="btn waves-effect waves-light  green darken-4" type="submit" name="submit" id="submit" style='width:230px'>₹30 rs
      <i class="material-icons right">send</i>
      </button>
    </form><br>
    <form action="addmoney.php" method="post">
      <input type="hidden" name="paybal" id="paybal" value="50">
      <button class="btn waves-effect waves-light green darken-4" type="submit" name="submit" id="submit" style='width:230px'>₹50 rs
      <i class="material-icons right">send</i>
      </button>
    </form><br>
    <form action="addmoney.php" method="post">
      <input type="hidden" name="paybal" id="paybal" value="100">
      <button class="btn waves-effect waves-light  green darken-4" type="submit" name="submit" id="submit" style='width:230px'>₹100 rs
      <i class="material-icons right">send</i>
      </button>
    </form><br>
    <form action="addmoney.php" method="post">
      <input type="hidden" name="paybal" id="paybal" value="200">
     <button class="btn waves-effect waves-light  green darken-4" type="submit" name="submit" id="submit" style='width:230px'>₹200 rs
      <i class="material-icons right">send</i>
      </button>
    </form><br>
    <form action="addmoney.php" method="post">
      <input type="hidden" name="paybal" id="paybal" value="300">
      <button class="btn waves-effect waves-light   green darken-4" type="submit" name="submit" id="submit" style='width:230px'>₹300 rs
      <i class="material-icons right">send</i>
      </button>
    </form><br>
    <form action="addmoney.php" method="post">
      <input type="hidden" name="paybal" id="paybal" value="400">
      <button class="btn waves-effect waves-light   green darken-4" type="submit" name="submit" id="submit" style='width:230px'>₹400 rs
      <i class="material-icons right">send</i>
      </button>
    </form><br>
    <form action="addmoney.php" method="post">
      <input type="hidden" name="paybal" id="paybal" value="500">
      <button class="btn waves-effect waves-light   green darken-4" type="submit" name="submit" id="submit" style='width:230px'>₹500 rs
      <i class="material-icons right">send</i>
      </button>
    </form>
