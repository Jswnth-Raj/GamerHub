...
<br>
<p class="white-text" style="font-size:20px;">Come join in our community with a passion to be apart of it...</p>
<p class="white-text"style="font-size:20px;">A Perfect place were you can find all information about Daily Challenges, Activities, Updates etc...</p>
<br>
<p class="center"><a href="https://www.facebook.com/gamerhubofficialpage/"><i style="font-size: 70px;" class="fa fa-facebook-square" aria-hidden="true"></i></a></p><br>
<p class="center"><a href="https://www.instagram.com/gamerhub.2020/"><i style="font-size: 60px;" class="fa fa-instagram" aria-hidden="true"></i></a></p><br>
<p class="center"><a href="http://t.me/gamerhub_2020"><i style="font-size: 60px;" class="fa fa-paper-plane" aria-hidden="true"></i></a></p><br>
<p class="center"><a href="mailto:gamerhubhelpdesk@gmail.com"><i style="font-size: 60px;" class="fa fa-envelope" aria-hidden="true"></i></a></p>
</div>
...
<footer class="page-footer  grey darken-4">
    <div class="container">
            ...
            <div class="row">
              ...
              <a href="https://www.fb.me/gamerhubofficialpage/"><i style="font-size: 20px;" class="fa fa-facebook"></i></a> &nbsp;&nbsp;
